...
def detect_walls(robot, ps, number_of_reads):
    ...
    avg4_right_sensor = 0    #ps4
    avg6_back_sensor = 0     #ps6
    avg0_left_sensor = 0     #ps0
    avg2_front_sensor = 0    #ps0
    ...
    for i in range(0,number_of_reads): #more scans for better accuracy
        ...
        avg4_right_sensor += ps_values[4]

        avg6_back_sensor += ps_values[6]

        avg0_left_sensor += ps_values[0]

        avg2_front_sensor += ps_values[2]

        robot.step(TIME_STEP) #simulation update

    #average score of sensors measurements
    avg4_right_sensor = avg4_right_sensor / number_of_reads
    avg6_back_sensor = avg6_back_sensor / number_of_reads
    avg0_left_sensor = avg0_left_sensor / number_of_reads
    avg2_front_sensor = avg2_front_sensor / number_of_reads
    avg_front_sensor = avg_front_sensor / number_of_reads

    #Wall detection
    left_wall = avg0_left_sensor > 80.0
    front_wall = avg2_front_sensor > 80.0
    right_wall = avg4_right_sensor > 80.0
    back_wall = avg6_back_sensor > 80.0
