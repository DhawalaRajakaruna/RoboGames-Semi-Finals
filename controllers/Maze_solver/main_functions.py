...
def floodfill_main(robot):
    ...
    while robot.step(TIME_STEP) != -1:
            ...
            if mode_params.TESTING:
                print('sensor ps2 front %.2f'% ps[2].getValue()) #do usuniecia

            if mode_params.TESTING:
                print('sensor ps0 left %.2f'% ps[0].getValue()) #do usuniecia
            
            if mode_params.TESTING:
                print('sensor ps4 right %.2f'% ps[4].getValue()) #do usuniecia
            ...
            match mode_params.MODE:
                case mode_params.SEARCH: #search
                    ...
                    left_wall, front_wall, right_wall, back_wall = map_f.detect_walls(robot, ps, 5)
...
# @retval None
'''   
def BFS_main(robot):# breadth first search
...
def init_devices(robot):
    ...
    ps_left = robot.getDevice("left encoder")
    ps_left.enable(TIME_STEP)
    ps_right = robot.getDevice("right encoder")
